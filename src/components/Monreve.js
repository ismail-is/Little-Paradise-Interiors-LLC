...
import MonrevePage from './shop-components/MonrevePage';

const Monreve  = () => {
    return <div>
        <NavbarV2 />
        <PageHeader headertitle="Monreve Apartment – 1 Bedroom Unit in Downtown Dubai"  customclass="mb-0" />
        {/* <ProductSliderV115/> */}
        <MonrevePage />
        {/* <CallToActionV1 /> */}
        <Footer />
