...
class Mbzpage extends Component {
                ...
                <div className="row">
                    ...
                    <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
                     ...
                     {/* <label id='responsive-text-project-title'><span className="ltn__secondary-color"><img src={publicUrl+"assets/img/Allimgs/pin.png"}/></span>Mangalore</label>  */}
                      <p   id='responsive-text-project-title'>This luxurious villa project is located in Abu Dhabi, United Arab Emirates and showcases a contemporary Arabic design approach blended with modern minimalism.The interiors feature a spacious lounge and reception hall with custom-made furniture, elegant lighting, and premium materials including marble and wood finishes.</p>
...
<div className="ltn__property-details-gallery mb-30" id='responsive-text-project-title'>
                        <div className="row">
                            ...
                            <a>
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/maz/mbz1.jpeg"} alt="Image" />
