...
class MeranoPage extends Component {
                ...
                <div className="row">
                    ...
                    <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
                     ...
                     {/* <label id='responsive-text-project-title'><span className="ltn__secondary-color"><img src={publicUrl+"assets/img/Allimgs/pin.png"}/></span>Mangalore</label>  */}
                      <p   id='responsive-text-project-title'>This 1-bedroom apartment in the heart of Dubai is designed for effortless urban living. A warm, neutral palette paired with modern finishes creates a calm and inviting atmosphere. The open-plan layout maximizes space, while cozy textures and curated decor add personality. It’s a perfect blend of style, comfort, and functionality in the city.</p>
...
<div className="ltn__property-details-gallery mb-30" id='responsive-text-project-title'>
                        <div className="row">
                            ...
                            <a>
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Merano/Merano1.webp"} alt="Image" />
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/maz/maz2.jpg"} alt="Image" /> */}
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Merano/Merano2.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Merano/Merano3.jpg"} alt="Image" />
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Merano/Merano4.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/Merano/Merano5.jpg"} alt="Image" /> */}
