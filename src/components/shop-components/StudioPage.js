                ...
                <div className="row">
                    ...
                    <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
                     ...
                     {/* <label id='responsive-text-project-title'><span className="ltn__secondary-color"><img src={publicUrl+"assets/img/Allimgs/pin.png"}/></span>Mangalore</label>  */}
                      <p   id='responsive-text-project-title'>This Dubai studio blends comfort and charm in a compact layout. Soft, neutral tones enhance the sense of space, while layered textures and warm lighting create a cozy ambiance. Thoughtfully designed storage and sleek finishes ensure functionality without compromising style-perfect for modern city living with a relaxed, inviting feel.</p>
...
<div className="ltn__property-details-gallery mb-30" id='responsive-text-project-title'>
                        <div className="row">
                            ...
                            <a>
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/studio/Studio1.jpg"} alt="Image" /> */}
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/maz/maz2.jpg"} alt="Image" /> */}
                                {/* <img className="mb-30" src={publicUrl+"assets/img/allimgLP/studio/Studio1.jpg"} alt="Image" /> */}
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/studio/Studio2.webp"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/studio/Studio3.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/studio/Studio4.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/studio/Studio5.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/studio/Studio6.jpg"} alt="Image" />
                                <img className="mb-30" src={publicUrl+"assets/img/allimgLP/studio/Studio7.jpg"} alt="Image" />
